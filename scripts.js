const contentArray = [
  ...
  },
  {
    ...
    sport: "<h3>Track</h3>",
    paragraph:
      "<p>Enola Savel is a recent graduate of Flagler College(Class of 2025) where she earned a double major in International Business and Business Administration. A dedicated student-athlete, she came to the U.S. from France on an athletic scholarship to compete in both cross country and track. Throughout her four years at Flagler, Enola balanced the rigors of collegiate athletics with the demands of a double major, developing a strong sense of focus, discipline, and determination. Her personal best in the 5K is an impressive 17:40. Now she serves as the assistant cross country and track & field coach at Flagler where she remains passionate about mentoring and supporting future student-athletes as they navigate both academic and athletic challenges. Due to her coaching role, she is only permitted to speaking with highschool juniors and seniors.</p>",
    button:
      "<a href='https://forms.zohopublic.com/samantharecruitrea1/form/Signup/formperma/wpXY_dX2znXplaX7ztEHhH7l1HEyvw3_wwAdWaqXWEU' target='_blank'><button class='btn btn-danger'>Book Now</button>",
    socialLinks: ``,
  },
